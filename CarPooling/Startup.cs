...
namespace CarPooling
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IRentalOfferServices, RentalOfferServices>();
            services.AddScoped<IRatingServices, RatingServices>();
            services.AddDbContext<CarpoolingContext>(options => options.UseSqlServer("server=.;database=CarpoolDB;trusted_connection=true;"));
